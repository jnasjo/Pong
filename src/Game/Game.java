...
public class Game {
	...
	/**
	 * Set's the onKeyPressed and onKeyReleased for this scene and player(s)
	 * 
	 * @param canMoveP1
	 *            Pass true to be able to move player 1
	 * @param canMoveP2
	 *            Pass true to be able to move player 2
	 */
	public void setOnAction(boolean canMoveP1, boolean canMoveP2) {
	...
	private void createPlayingField() {
		...
		shape.drawLine(CANVAS_WIDTH / 2 - 1, 0, CANVAS_WIDTH / 2 - 1,
				CANVAS_HEIGHT, 2, SCORE_TEXT_COLOR).toBack(); // Color.rgb(234,
																// 234, 234)
	}
	...
	public void updatePlayerScore(int score1, int score2) {
		// Remove old score
		root.getChildren().remove(p1Score);
		root.getChildren().remove(p2Score);
		// Add new score
	...
	public void displayMessage(String msg) {
		...
		text = shape.drawText(CANVAS_WIDTH/2, CANVAS_HEIGHT/4,
				CANVAS_HEIGHT/10, Shape.TextDirection.CENTER_TEXT, msg, Color.rgb(255, 130, 46));
